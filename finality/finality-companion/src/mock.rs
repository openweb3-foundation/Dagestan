...
use super::*;
use crate as stance_finality_companion;
...
construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic,
    {
        ...
        StanceFGCompanion: stance_finality_companion::{Pallet, Storage, Event<T>},
...
pub fn new_test_ext(authorities: &[(u64, u64)]) -> sp_io::TestExternalities {
    ...
    let session_keys: Vec<_> = authorities
        ...
        .enumerate()
        .map(|(i, (k, _))| (i as u64, i as u64, TestSessionKeys { stance: k }))
        .collect();
...
pub(crate) fn run_session(n: u32) {
    for i in Session::current_index()..n {
        ...
        StanceFGCompanion::on_finalize(System::block_number());
        ...
        StanceFGCompanion::on_initialize(System::block_number());
    }
}
