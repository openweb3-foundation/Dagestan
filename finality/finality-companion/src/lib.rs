...
//! This pallet is a runtime companion of Stance finality gadget.
//!
//! Currently, it only provides support for changing sessions but in the future
//! it will allow reporting equivocation in Stance.
        ...
        fn on_runtime_upgrade() -> frame_support::weights::Weight {
            ...
            T::DbWeight::get().reads(1)
                + match on_chain {
                    ...
                    _ => {
                        log::warn!(
                            target: "stance_finality_companion",
                            "On chain storage version of stance finality gadget companion is {:?} but it should not be bigger than 2",
                            on_chain
                        );
                        0
                    }
