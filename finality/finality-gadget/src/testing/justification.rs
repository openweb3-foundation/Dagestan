...
use crate::{
    justification::{StanceJustification, JustificationHandler, JustificationHandlerConfig},
    testing::mocks::{
...
fn create_justification_notification_for(block: TBlock) -> JustificationNotification<TBlock> {
    JustificationNotification {
        justification: StanceJustification::CommitteeMultisignature(SignatureSet::with_size(
            0.into(),
        )),
        hash: block.hash(),
